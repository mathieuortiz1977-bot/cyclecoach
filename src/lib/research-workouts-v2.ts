...
export const RESEARCH_WORKOUTS_V2: WorkoutTemplate[] = [
  ...
  { id: 'w126', title: 'FTP with 30s Bursts', description: 'FTP durability with race-like surges', category: 'THRESHOLD', duration: 75, zone: 'Z4', purpose: 'Sustain FTP with periodic surges', intervals: () => [], protocol: 'Threshold+', researcher: 'Carlos', structure: 'mixed', difficultyScore: 8 },
  { id: 'w127', title: 'Threshold with Declining Rest', description: 'Lactate tolerance under increasing pressure', category: 'THRESHOLD', duration: 70, zone: 'Z4', purpose: 'Lactate clearance with decreasing recovery', intervals: () => [], protocol: 'Threshold+', researcher: 'Carlos', structure: 'mixed', difficultyScore: 8 },
  { id: 'w128', title: 'VO2max Surge on Threshold', description: 'VO2max intervals layered over FTP base', category: 'VO2MAX', duration: 70, zone: 'Z5', purpose: 'VO2 intervals with high lactate baseline', intervals: () => [], protocol: 'Threshold+', researcher: 'EVOQ', structure: 'mixed', difficultyScore: 9 },

  // ─── CATEGORY F: ENDURANCE VARIANTS (W129-W131) ───────────────────────

  { id: 'w129', title: 'Café Ride with Purpose', description: 'Social endurance ride with structured blocks', category: 'BASE', duration: 120, zone: 'Z2', purpose: 'Group dynamics with training value', intervals: () => [], protocol: 'Social Endurance', researcher: 'Carlos', structure: 'mixed', difficultyScore: 4 },
  { id: 'w130', title: '3-Hour Endurance Foundation', description: 'Pure aerobic base for event prep', category: 'BASE', duration: 180, zone: 'Z2', purpose: 'Long aerobic capacity building', intervals: () => [], protocol: 'Long Steady', researcher: 'Seiler', structure: 'steady', difficultyScore: 3 },
  { id: 'w131', title: 'Endurance with Tempo Climbs', description: 'Simulate undulating terrain endurance ride', category: 'BASE', duration: 120, zone: 'Z3', purpose: 'Muscular endurance on varied terrain', intervals: () => [], protocol: 'Undulating', researcher: 'Carlos', structure: 'mixed', difficultyScore: 5 },

  // ─── CATEGORY G: ANAEROBIC & SPRINT VARIANTS (W132-W135) ───────────────

  { id: 'w132', title: 'The Wringer Light', description: 'Anaerobic repeats with decreasing rest (accessible)', category: 'ANAEROBIC', duration: 50, zone: 'Z6', purpose: 'Anaerobic training with lower volume', intervals: () => [], protocol: 'Anaerobic', researcher: 'Carlos', structure: 'repeats', difficultyScore: 8 },
  { id: 'w133', title: 'Sprint Ladder', description: 'Full-spectrum sprint development', category: 'SPRINT', duration: 55, zone: 'Z6', purpose: 'Multi-duration sprint training', intervals: () => [], protocol: 'Sprint Ladder', researcher: 'Carlos', structure: 'ladder', difficultyScore: 7 },
  { id: 'w134', title: '20/40 Anaerobic Repeats', description: 'High power density with moderate recovery', category: 'ANAEROBIC', duration: 55, zone: 'Z6', purpose: 'Peak power repeatability', intervals: () => [], protocol: 'Anaerobic', researcher: 'Carlos', structure: 'repeats', difficultyScore: 8 },
  { id: 'w135', title: 'Standing Power Intervals', description: 'Out-of-saddle power and recruitment', category: 'ANAEROBIC', duration: 60, zone: 'Z5', purpose: 'Climbing and attack power', intervals: () => [], protocol: 'Standing Power', researcher: 'Carlos', structure: 'repeats', difficultyScore: 8 },

  // ─── CATEGORY H: MUSCULAR ENDURANCE & LOW CADENCE (W136-W138) ─────────

  { id: 'w136', title: 'Force-Velocity Contrast', description: 'Alternate high-torque and high-spin at same power', category: 'SWEET_SPOT', duration: 70, zone: 'Z3', purpose: 'Force across full RPM spectrum', intervals: () => [], protocol: 'Force-Velocity', researcher: 'Carlos', structure: 'mixed', difficultyScore: 7 },
  { id: 'w137', title: 'Low-Cadence Threshold', description: 'Climbing-specific FTP development', category: 'THRESHOLD', duration: 70, zone: 'Z4', purpose: 'Steep gradient FTP work', intervals: () => [], protocol: 'Low Cadence', researcher: 'Paton/Hopkins', structure: 'repeats', difficultyScore: 8 },
  { id: 'w138', title: 'Seated/Standing Alternation', description: 'Position-specific power development', category: 'THRESHOLD', duration: 65, zone: 'Z4', purpose: 'Transition power without loss', intervals: () => [], protocol: 'Position Shifts', researcher: 'Carlos', structure: 'mixed', difficultyScore: 7 },

  // ─── CATEGORY I: MASTERS-SPECIFIC SESSIONS (W139-W141) ────────────────

  { id: 'w139', title: 'Masters VO2max (Conservative)', description: 'VO2 stimulus with extended warm-up', category: 'VO2MAX', duration: 70, zone: 'Z5', purpose: 'Age-appropriate VO2 training', intervals: () => [], protocol: 'Masters', researcher: 'Carlos', structure: 'repeats', difficultyScore: 8 },
  { id: 'w140', title: 'Masters Sweet Spot', description: 'FTP development with recovery-friendly load', category: 'SWEET_SPOT', duration: 75, zone: 'Z3', purpose: 'Consistent execution over aggressive targets', intervals: () => [], protocol: 'Masters', researcher: 'Carlos', structure: 'repeats', difficultyScore: 6 },
  { id: 'w141', title: 'Masters Tempo Endurance', description: 'Aerobic endurance with moderate stress', category: 'TEMPO', duration: 90, zone: 'Z3', purpose: 'Zone 3 sweet spot for masters', intervals: () => [], protocol: 'Masters', researcher: 'Carlos', structure: 'steady', difficultyScore: 5 },

  // ─── CATEGORY J: PRE-RACE / TAPER WORKOUTS (W142-W143) ──────────────

  { id: 'w142', title: 'Race Eve Sharpener', description: 'Final activation the day before racing', category: 'SPRINT', duration: 30, zone: 'Z3', purpose: 'Nervous system priming', intervals: () => [], protocol: 'Taper', researcher: 'Carlos', structure: 'mixed', difficultyScore: 3 },
  { id: 'w143a', title: '3-Day Taper Sequence Day 1', description: '60 min: 10 easy + 20 at 85% + 2x5 at 95%/55% + 10 CD', category: 'TEMPO', duration: 60, zone: 'Z3', purpose: '3-day pre-race sequence, day 1', intervals: () => [], protocol: 'Taper', researcher: 'Carlos', structure: 'mixed', difficultyScore: 4 },
  { id: 'w143b', title: '3-Day Taper Sequence Day 2', description: '45 min: 10 easy + 15 at 70% + 3x1 at 100% + 10 CD', category: 'THRESHOLD', duration: 45, zone: 'Z3', purpose: '3-day pre-race sequence, day 2', intervals: () => [], protocol: 'Taper', researcher: 'Carlos', structure: 'mixed', difficultyScore: 3 },
  { id: 'w143c', title: '3-Day Taper Sequence Day 3 (Race Eve)', description: '30 min: W142 sharpener', category: 'SPRINT', duration: 30, zone: 'Z2', purpose: '3-day pre-race sequence, day 3 (race eve)', intervals: () => [], protocol: 'Taper', researcher: 'Carlos', structure: 'mixed', difficultyScore: 2 },
